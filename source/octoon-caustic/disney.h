...
namespace octoon
{
	namespace caustic
	{
		RadeonRays::float4 Disney_Sample(const RadeonRays::float3& N, const RadeonRays::float3& wi, const Material& mat, const RadeonRays::float2& Xi, RadeonRays::float4& wo) noexcept;
